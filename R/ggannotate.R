...
#'
#' @return Called for its side effects. When the gadget is closed via
#'   the "Copy code" or "Done" button, the generated annotation code
#'   is copied to the clipboard. Returns `NULL` invisibly.
#'
#' @examples
#'
#' if (interactive()) {
